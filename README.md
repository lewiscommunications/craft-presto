...
To clear the Presto cache, navigate to Presto plugin settings page (*https://example.com/cms/settings/plugins/presto*) and click "Purge Cache" ([immediate](#immediate-purge)) or "Schedule Purge" ([cron](#cron-purge)).
